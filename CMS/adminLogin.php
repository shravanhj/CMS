...
if(isset($_POST['submit'])){
    ...
    $select_user = $conn->prepare("SELECT * FROM `admins` WHERE email = ? AND password = ?");
...
?>
    <h4 style="padding:5px; text-align:left; border-bottom:2px solid black; ">CSM Admin Login</h4>
    <div class="mb-2">
...
<label for="logIn" class="label">Admin Registration <a href="adminSignup.php" style="text-decoration:none;">Click Here.</a></label>
</div>
</div>
